...
const Alert = () => {
  return (
      <div id="alert-border-3" className="flex items-center p-4 mb-4 text-white border-t-4 border-green-300 bg-green-500" role="alert">
          ...
          <div className="ml-3 text-xl font-medium font-righteous">
