...
import { userDeletesAtom } from "../../../logic/atoms/details";

const ModalDeleteUser = ({visible, close}) => {
    const data = useRecoilValue(userDeletesAtom)
    ...
    const submitHandler = async (ev) => {
        ...
        try {
            ...
            await deleteRequest(`api/nextlaundry/admin/user`, JSON.stringify(json), `Bearer ${token}`).then((res) => {
                toast.update(id, {
        ...
        <>
            <Modal width='35%' open={visible} closeButton onClose={close} aria-labelledby="modal-delete-user" css={{ fontFamily: "Righteous" }}>
                ...
                <form onSubmit={submitHandler}>
                    <Modal.Body>
                        <Text css={{ fontFamily: "Righteous"}}>Are You Sure Want To Delete {data.fullname} ?</Text>
                    </Modal.Body>
                    <Modal.Footer>
